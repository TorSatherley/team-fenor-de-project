...
class TestConnection:
    ...
    def test_create_conn(
        ...
        with mock_aws():
            mock_sm_client = boto3.client(service_name="secretsmanager", region_name="eu-west-2")
...
class TestWriteTableToS3:
    ...
    def test_write_table_to_s3(self, mock_datetime, mock_pd_DataFrame):
        ...
        key = write_table_to_s3(mock_s3_client, mock_bucket, mock_table, mock_rows, mock_columns, mock_date_and_time)
